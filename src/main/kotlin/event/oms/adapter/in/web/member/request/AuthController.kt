...
class AuthController(
    ...
    @PostMapping("/signup")
    fun signUp(@Valid @RequestBody request: SignUpRequest): ResponseEntity<BaseResponse<MemberResponse>> {
    ...
    @PostMapping("/login")
    fun login(@Valid @RequestBody request: LoginRequest): ResponseEntity<BaseResponse<TokenResponse>> {
        val command = request.toCommand()
    ...
    @PostMapping("/refresh")
    fun refresh(@Valid @RequestBody request: RefreshRequest): ResponseEntity<BaseResponse<TokenResponse>> {
        val command = request.toCommand()
